    ...
    class Program
    {
        ...
        private static void oncast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (spell.Name == "Swipe")
            {
                ...
                {
                    Utility.DelayAction.Add(300-Game.Ping/2,() => Q.Cast(Player.Position));
                }
            }
            if (spell.Name == "Pounce")
            {
                ...
                //{
                //    Utility.DelayAction.Add(100 - Game.Ping / 2, () => Player.IssueOrder(GameObjectOrder.AttackUnit,TTar));
                //}
            }
        ...
        private static void AfterAttack(AttackableUnit unit, AttackableUnit target)
        {
            ...
            if (Orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo)
            {
                ...
                {
                   Utility.DelayAction.Add(500,() => castQtarget(target));
                }
            }
